...
SELECT $DB_NAME$Views.SP_DCPUpsertUser (0, 'DEACTIVATED', 'ST', '', '', NULL, NULL, NULL,NULL,NULL);
SELECT $DB_NAME$Views.SP_DCPDeactivateUser(0);

SELECT $DB_NAME$Views.SP_DCPUpsertTeacher(0, JSONB('{"currentclasses": [{"classid":0}]}'));
