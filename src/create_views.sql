...
-- Lookup
CREATE OR REPLACE VIEW $APP_NAME$Views.Lookup_Reward AS SELECT * FROM $APP_NAME$.Lookup_Reward WHERE EndTS = TIMESTAMP '9999-12-31 23:59:59';
CREATE OR REPLACE VIEW $APP_NAME$Views.Lookup_RewardAll AS SELECT * FROM $APP_NAME$.Lookup_Reward;
