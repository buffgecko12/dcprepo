...
CREATE OR REPLACE VIEW $APP_NAME$Views.FileHist AS SELECT * FROM $APP_NAME$.File; -- History rows
...
CREATE OR REPLACE VIEW $APP_NAME$Views.SchoolHist AS SELECT * FROM $APP_NAME$.School WHERE SchoolId <> 0; -- History rows
...
CREATE OR REPLACE VIEW $APP_NAME$Views.ContractHist AS SELECT * FROM $APP_NAME$.Contract;
...
-- Users
CREATE OR REPLACE VIEW $APP_NAME$Views.UsersHist AS SELECT * FROM $APP_NAME$.Users;
...
CREATE OR REPLACE VIEW $APP_NAME$Views.RewardHist AS SELECT * FROM $APP_NAME$.Reward;
...
CREATE OR REPLACE VIEW $APP_NAME$Views.Teacher_ProgramHist AS SELECT * FROM $APP_NAME$.Teacher_Program;
