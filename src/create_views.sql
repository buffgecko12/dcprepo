...
CREATE OR REPLACE VIEW $APP_NAME$Views.User_Group AS SELECT * FROM $APP_NAME$.User_Group;
...
CREATE OR REPLACE VIEW $APP_NAME$Views.Contract_Party_Evaluation AS SELECT * FROM $APP_NAME$.Contract_Party_Evaluation;
