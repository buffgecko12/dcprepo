...
SELECT * FROM $APP_NAME$Views.SP_DCPUpsertTeacher(4, 500000,
	JSONB(
	'{
		"deletedclasses": [],
		"currentclasses": [
...
SELECT * FROM $APP_NAME$Views.SP_DCPUpsertContract(
	NULL,'New contract', 1,'G',3,TSTZRANGE(current_timestamp,current_timestamp + INTERVAL '1' MONTH,'[]'),FALSE,current_timestamp + INTERVAL '14' DAY,'Some student leader requirements',NULL,NULL,NULL,
