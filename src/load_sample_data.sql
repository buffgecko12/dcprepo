...
-- Add sample reward
SELECT $APP_NAME$Views.SP_DCPUpsertReward(NULL, 2020, 'Tiquetes al cine', 'Tiquetes al cine en Innovo.', 6000, 'Innovo');
SELECT $APP_NAME$Views.SP_DCPUpsertReward(NULL, 2020, 'Pizza', 'Pizza y gaseosa.', 5000, 'Pizza Show');
SELECT $APP_NAME$Views.SP_DCPUpsertReward(NULL, 2020, 'Hamburguesa', 'Hamburguesa y gaseoas.', 5000, 'Cowfish');
SELECT $APP_NAME$Views.SP_DCPUpsertReward(NULL, 2020, 'Guatika', 'Tiquete a Guatika.', 25000, 'Guatika');