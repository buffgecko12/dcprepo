-- Update files
SELECT $APP_NAME$Views.SP_DCPUpsertFile(100,'MySchoolDataPolicy','.pdf',1000,'pdf','My description',NULL,'PB');

-- Create schools/classes
SELECT $APP_NAME$Views.SP_DCPUpsertSchool(100, 'Test School 1', 'TS1', 'My Address','Duitama','Boyaca', 100, NULL); -- Schools
SELECT $APP_NAME$Views.SP_DCPUpsertClass(100, 100, '10-03',10); -- Classes
SELECT $APP_NAME$Views.SP_DCPUpsertClass(101, 100, '10-01',10); -- Classes
SELECT $APP_NAME$Views.SP_DCPUpsertClass(102, 100, '9-05',9); -- Classes

-- Add users
SELECT $APP_NAME$Views.SP_DCPUpsertUser (100, 100, 'MyTeacher','TR','Joe','Smith',NULL,'MyPhone','joe1@smith.com',NULL,'U',NULL,NULL);
SELECT $APP_NAME$Views.SP_DCPUpsertUser (101, 100, 'MyStudent1','ST','Nic','Cage',NULL,'MyPhone','nic@cage.com',NULL,'U',NULL,NULL);
SELECT $APP_NAME$Views.SP_DCPUpsertUser (102, 100, 'MyStudent2','ST','Sean','Connery',NULL,'MyPhone','the@besht.com',NULL,'U',NULL,NULL);
SELECT $APP_NAME$Views.SP_DCPUpsertUser (103, 100, 'MyStudent3','ST','Elsa','Benitez',NULL,'MyPhone1','the@shipoopee.com',NULL,'U',NULL,NULL);

-- Create user group
SELECT $APP_NAME$Views.SP_DCPUpsertUserGroup(NULL, 'New Group', 100, 101, ARRAY[101,102,103]);

-- Add user notification
SELECT $APP_NAME$Views.SP_DCPUpsertUserNotification (100, 1001, NULL);

-- Add teacher info
SELECT $APP_NAME$Views.SP_DCPUpsertTeacher(100, 200000, JSONB('{"deletedclasses": [],"currentclasses": [{"classid":100},{"classid":101}]}'));
SELECT $APP_NAME$Views.SP_DCPUpsertTeacher(100, 200000, JSONB('{"deletedclasses": [101],"currentclasses": [{"classid":102}]}'));
SELECT $APP_NAME$Views.SP_DCPUpsertTeacherBudget(100,500000);

-- Add student info
SELECT $APP_NAME$Views.SP_DCPUpsertStudent(101,100);
SELECT $APP_NAME$Views.SP_DCPUpsertStudent(102,100);

-- Modify student info
SELECT $APP_NAME$Views.SP_DCPUpsertStudent(101,0);
...
-- Get reward info
SELECT $APP_NAME$Views.SP_DCPGetReward(1,NULL,NULL,NULL);

-- Deactivate reward
SELECT $APP_NAME$Views.SP_DCPDeactivateReward(1);
SELECT $APP_NAME$Views.SP_DCPDeactivateReward(2);
...
-- Duplicate contract
SELECT $APP_NAME$Views.SP_DCPDuplicateContract(100, 102, 100, NULL);

-- Copy contract
SELECT $APP_NAME$Views.SP_DCPCopyContract(100, 999);
SELECT $APP_NAME$Views.SP_DCPChangeContractStatus(999,'D');

-- Change status to 'active'
SELECT $APP_NAME$Views.SP_DCPChangeContractStatus(100,'A');
...
SELECT $APP_NAME$Views.SP_DCPDeleteContractGoalReward(100,2,1);
SELECT $APP_NAME$Views.SP_DCPDeleteContractGoalReward(100,NULL,NULL);
...
-- Get contract info
SELECT $APP_NAME$Views.SP_DCPGetContract(100,NULL,NULL,NULL,NULL);
SELECT $APP_NAME$Views.SP_DCPGetContractInfo(100, NULL);
...
-- Revise contract
SELECT $APP_NAME$Views.SP_DCPReviseContract(100,'revise','test revision',NULL);

-- Get school/class info
SELECT $APP_NAME$Views.SP_DCPGetSchool(100);
SELECT $APP_NAME$Views.SP_DCPGetClass(100,NULL,NULL,NULL);

-- Get user info
SELECT $APP_NAME$Views.SP_DCPGetStudent(101, NULL);
SELECT $APP_NAME$Views.SP_DCPGetTeacher(100);
SELECT $APP_NAME$Views.SP_DCPGetTeacherClass(100, 100);
SELECT $APP_NAME$Views.SP_DCPGetTeacherClass(100, NULL);
SELECT $APP_NAME$Views.SP_DCPGetTeacherBudget(100);
...
SELECT $APP_NAME$Views.SP_DCPGetUserGroup(1, NULL, NULL);

-- Other
SELECT $APP_NAME$Views.SP_DCPDeactivateUser(101);
...
SELECT $APP_NAME$Views.SP_DCPResetContractPartyVote(100,100);
SELECT $APP_NAME$Views.SP_DCPResetContractPartyVote(100,NULL);

SELECT SP_DCPGetFile(100);
...
SELECT $APP_NAME$Views.SP_DCPDeleteFile(100);

SELECT $APP_NAME$Views.SP_DCPDeleteUser(100);
SELECT $APP_NAME$Views.SP_DCPDeleteUser(101);

-- Delete user group (do this in the middle of deleting other users
SELECT $APP_NAME$Views.SP_DCPDeleteUserGroup(1);
...
SELECT $APP_NAME$Views.SP_DCPChangeContractStatus(100,'D');
SELECT $APP_NAME$Views.SP_DCPDeleteContract(100, NULL);
SELECT $APP_NAME$Views.SP_DCPDeleteContract(1, NULL); -- Duplicate Contract
SELECT $APP_NAME$Views.SP_DCPDeleteContract(2, NULL); -- Revise Contract
SELECT $APP_NAME$Views.SP_DCPDeleteContract(999, NULL); -- Copy Contract
