...
-- Add teacher info
SELECT * FROM $DB_NAME$Views.SP_DCPUpsertTeacher(100, 100, JSONB('{"deletedclasses": [],"currentclasses": [{"classid":100},{"classid":101}]}'));
SELECT * FROM $DB_NAME$Views.SP_DCPUpsertTeacher(100, 100, JSONB('{"deletedclasses": [101],"currentclasses": [{"classid":102}]}'));
